<?php
// apply.php
// You can add PHP logic here later (e.g., fetching job options from DB, validation, sessions, etc.)
?>
...
<body>
  ...
  <header class="header">
    <ul class="header__list">
      ...
      <li class="header__item"><a href="about.php">About</a></li>
      <li class="header__item"><a href="job.php">Careers</a></li>
      <li class="header__item"><a href="apply.php">Apply</a></li>
    </ul>
  </header>
  ...
  <form action="submit_eoi.php" method="post">
    ...
    <p>
      You go here to apply for a job. We have various jobs for you to do.<br>
    ...
    <fieldset>
      ...
      <p>
        ...
        <label for="mth">Kru Yai in Muay Thai (very important)</label> 
